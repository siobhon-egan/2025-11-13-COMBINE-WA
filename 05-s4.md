...
A number of standard operations with `Rle` objects are documented in the help page of the `Rle` class, accessible as `?Rle`, and in the vignettes of the *[S4Vectors](https://bioconductor.org/packages/3.22/S4Vectors)* package, accessible using `browseVignettes("S4Vectors")`.
