...
One such Bioconductor package is *[biomaRt](https://bioconductor.org/packages/3.22/biomaRt)*.

Instead, in the 'Annotation' section, we find packages that do contain
annotations.
Examples include *[org.Hs.eg.db](https://bioconductor.org/packages/3.22/org.Hs.eg.db)*,
*[EnsDb.Hsapiens.v86](https://bioconductor.org/packages/3.22/EnsDb.Hsapiens.v86)*,
and *[TxDb.Hsapiens.UCSC.hg38.knownGene](https://bioconductor.org/packages/3.22/TxDb.Hsapiens.UCSC.hg38.knownGene)*.

In this episode, we will demonstrate the two approaches:

* Querying annotations from the Ensembl Biomart API using the *[biomaRt](https://bioconductor.org/packages/3.22/biomaRt)* package.
* Querying annotations from the *[org.Hs.eg.db](https://bioconductor.org/packages/3.22/org.Hs.eg.db)* annotation package.
...
*[biomaRt](https://bioconductor.org/packages/3.22/biomaRt)* is a Bioconductor software package that
...
By default, *[biomaRt](https://bioconductor.org/packages/3.22/biomaRt)* functions access the latest
...
provides the URL that *[biomaRt](https://bioconductor.org/packages/3.22/biomaRt)* functions will need to
...
provides the identifier that *[biomaRt](https://bioconductor.org/packages/3.22/biomaRt)* functions will
...
The function `getBM()` is the main *[biomaRt](https://bioconductor.org/packages/3.22/biomaRt)* query
function.
...
defined in the *[AnnotationDbi](https://bioconductor.org/packages/3.22/AnnotationDbi)* package.
...
In this example, we will use the *[org.Hs.eg.db](https://bioconductor.org/packages/3.22/org.Hs.eg.db)*
...
| GPSOURCEDATE: UTC-Sep26
| ENSOURCEDATE: 2025-Sep03
| ENSOURCENAME: Ensembl
| ENSOURCEURL: ftp://ftp.ensembl.org/pub/current_fasta
| UPSOURCENAME: Uniprot
| UPSOURCEURL: http://www.UniProt.org/
| UPSOURCEDATE: Sat Oct  4 09:48:11 2025
```
...
*[AnnotationDbi](https://bioconductor.org/packages/3.22/AnnotationDbi)* functions for running queries and
...
values,
as the full set comprises 193512
values.
...
The function `select()` is the main *[AnnotationDbi](https://bioconductor.org/packages/3.22/AnnotationDbi)*
query function.
...
One small but notable difference with *[biomaRt](https://bioconductor.org/packages/3.22/biomaRt)* is that
...
Load the packages *[EnsDb.Hsapiens.v86](https://bioconductor.org/packages/3.22/EnsDb.Hsapiens.v86)* and
